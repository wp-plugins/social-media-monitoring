<?php
	...
	class MonitoringAdmin {
		...
		function getAdminOptions() {
			$devloungeAdminOptions = array('keyword' => '', credits => '', 'shq_c_b' => 'CCCCCC', 'shq_c_i_b' => 'CCCCCC', 'shq_c_f' => 'arial,sans-serif', 'shq_c_h_c' => '3F6EBA', 'shq_c_f_c' => '000000', 'shq_c_bg' => 'ffffff', 'w_shq_c_b' => 'CCCCCC', 'w_shq_c_i_b' => 'CCCCCC', 'w_shq_c_f' => 'arial, sans_serif', 'w_shq_c_h_c' => '3F6EBA', 'w_shq_c_f_c' => '000000', 'w_shq_c_bg' => 'ffffff', 'w_shq_c_l' => '2556A4', 'shq_c_po' => 3, 'shq_c_wi' => '280', 'shq_c_l' => '2556A4');
		...
		function printAdminPage() {
                    ...
                    if (isset($_POST['update_devloungePluginSeriesSettings'])) {
                        ...
                        if (isset($_POST['devloungeWidth'])) {
                                $devOptions['shq_c_wi'] = apply_filters('keyword_save_pre', $_POST['devloungeWidth']);
                        }
                        if (isset($_POST['devloungeLinksColor'])) {
                                $devOptions['shq_c_l'] = apply_filters('keyword_save_pre', $_POST['devloungeLinksColor']);
                        }
                        if (isset($_POST['devloungeShowBorder'])) {
                        ...
                        if (isset($_POST['devloungeLinksColor'])) {
                                $devOptions['w_shq_c_l'] = apply_filters('keyword_save_pre', $_POST['devloungeLinksColor']);
                        }
                        if (isset($_POST['devloungeFontType'])) {
  ...
  background-color: #408140 \9;
                        ...
                        <div class="wrap">
                            <div style="float:left;width:60%">
                                ...
                                <p><input name="devloungeContent" class="input_kwd" value="<?php echo $devOptions['keyword'] ?>" required></p>
                                </div>

                                <div class="row">
                                <h3>Enter Email Address</h3>
                                <p><input name="devloungeEmail" class="input_kwd" value="<?php echo get_option('admin_email') ?>" required></p>
                                ...
                                <p style="margin-left: 7px;"><input type="number" name="devloungePosts" class="input_color" value="<?php echo $devOptions['shq_c_po'] ?>" min="2" max="10" required></p>
                                </div>

                                <div class="row">
                                <h3>Width</h3>
                                <p><span style="margin-left:-6px;">px</span><input type="number" name="devloungeWidth" class="input_color" min="250" max="728" value="<?php echo $devOptions['shq_c_wi'] ?>" required></p>
                                </div>
                                ...
                                <div class="row">
                                <h3>Color of Links</h3>
                                <p>#<input name="devloungeLinksColor" class="input_color" value="<?php echo $devOptions['shq_c_l'] ?>"></p>
                                </div>

                                <div class="row">
                                <h3>Font Type</h3>
                                <p style="margin-left: -2px;"><input name="devloungeFontType" class="input_font" value="<?php echo $devOptions['shq_c_f'] ?>"></p>
                                </div>
                                ...
                                <div class="row">
                                <h3>Color of Links</h3>
                                <p>#<input name="devloungeLinksColor" class="input_color" value="<?php echo $devOptions['w_shq_c_l'] ?>"></p>
                                </div>

                                <div class="row">
                                <h3>Font Type</h3>
                                <p style="margin-left: -2px;"><input name="devloungeWFontType" class="input_font" value="<?php echo $devOptions['w_shq_c_f'] ?>"></p>
                                </div>
                                ...
                                <div style="float:left;">Next, <a href="/wp-admin/widgets.php" class="btn-success"><strong>Choose location of Monitoring Widget</strong></a></div>
                            </div>
