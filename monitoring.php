    ...
    <?php
      ...
      function widget($args, $instance)
      {
        ...
        if(($monitoring_variables['show_socialapp_link']==1)){
            echo "<br/><span style='font-size:12px;font-family:arial;'><a href='https://widget.socialappshq.com/widget/landing' style='cursor:pointer;text-decoration:none;color:#3F6EBA;' target='_blank'>Online Monitoring</a> by <a href='https://www.socialappshq.com' target='_blank' style='cursor:pointer;text-decoration:none;color:#3F6EBA;'>SocialAppsHQ</a></span></div>";
        }
